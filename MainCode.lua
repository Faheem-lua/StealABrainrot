...
local serverhopBtn = createModernButton(moreContent, "🔄 SERVER HOP", UDim2.new(0, 0, 0, 50))

local creditsLabel = Instance.new("TextLabel", moreContent)
creditsLabel.Size = UDim2.new(1, 0, 0, 40)
creditsLabel.Position = UDim2.new(0, 0, 0, 105) 
creditsLabel.BackgroundTransparency = 1
creditsLabel.Text = "💜 Credits to Faheem"
